...
class JwcKebiaoScreen extends Component {
  constructor(props) {
    ...
    this.tableHeaders = [
      ...
      {name: t("jwcKebiaoScreen.classroom"), field: "classroom", minW: 80},
      {name: t("jwcKebiaoScreen.mon_12"), field: "mon_12", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.mon_34"), field: "mon_34", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.mon_56"), field: "mon_56", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.mon_78"), field: "mon_78", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.tue_12"), field: "tue_12", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.tue_34"), field: "tue_34", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.tue_56"), field: "tue_56", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.tue_78"), field: "tue_78", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.wed_12"), field: "wed_12", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.wed_34"), field: "wed_34", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.wed_56"), field: "wed_56", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.wed_78"), field: "wed_78", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.thu_12"), field: "thu_12", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.thu_34"), field: "thu_34", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.thu_56"), field: "thu_56", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.thu_78"), field: "thu_78", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.fri_12"), field: "fri_12", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.fri_34"), field: "fri_34", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.fri_56"), field: "fri_56", dataType: "course_teacher_combined", minW: 180},
      {name: t("jwcKebiaoScreen.fri_78"), field: "fri_78", dataType: "course_teacher_combined", minW: 180},
    ];
    this.tableData = null;
